...
class Kriptomist:
    ...
    def compute_stats(self):
        ...
        # compare
        self.cmp28 = div0(self.subs28_rel, self.price28_rel)
        self.cmp7 = div0(self.subs7_rel, (3 + self.price28_rel) / 4)
        self.cmp1 = div0(self.subs1_rel, (27 + self.price28_rel) / 28)

        # score
        self.score = self.cmp1 * self.cmp7 * self.cmp28 * (self.subs1_acc ** 4) * (self.subs7_acc ** 2)
